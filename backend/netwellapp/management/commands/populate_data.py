        ...
        blog_posts = [
            {
                ...
                'body': """There's nothing more confusing than seeing full Wi-Fi bars on your phone while every page refuses to load. Your device says you're connected, but WhatsApp won't send, YouTube won't play, and your browser just spins. This is one of the most common internet complaints in Kenyan homes, and in most cases, it has nothing to do with your phone. Here are eight things to check before you give up and call for help.
...
If you're on a data plan rather than an unlimited package, an expired bundle will often still show \"connected\" on your Wi-Fi icon even though you have no data left to browse with. Check your account balance through your provider's app or a quick SMS/USSD check before assuming it's a technical fault.

3. Look for an outage in your area

Sometimes the issue isn't in your house at all. Roadworks, storms, or maintenance work nearby can affect the line reaching your home. Check your provider's official social media pages or support line to see if there's a known outage in your area.

4. Check the lights on your fibre box

The small box mounted on your wall (the ONT) usually has indicator lights for power, signal, and internet. If the \"internet\" or \"LOS\" light is red or off, the problem is likely with the incoming line rather than your router, and you'll need to report it to your provider.

5. Forget the network and reconnect

On your phone or laptop, go to Wi-Fi settings, \"forget\" the network, then reconnect using the password. This clears up small glitches where your device thinks it's connected but is actually stuck on an old, broken connection.
...
Routers can only comfortably handle so many devices at once. If your household has many phones, laptops, smart TVs, and CCTV cameras all connected, some devices may show as connected while getting almost no bandwidth. Disconnect devices you're not using and test again.

If you've gone through all eight steps and you're still stuck, the fault is most likely on the line itself, not in your home.

Netwell Fiber customers get fast, reliable connections backed by a support team that responds quickly when something goes wrong. If your internet still isn't working after trying these fixes, reach out to Netwell Fiber support and we'll get you back online, no long hold times, no runaround.""",
            ...
            },
            {
                ...
                'body': """Internet that was working perfectly and then suddenly stops is one of the most frustrating situations, especially in the middle of work, a stream, or a video call. Before you panic or start unplugging things at random, work through this checklist. Most of the time, the cause is something quick to spot and even quicker to fix.

Check for a power interruption

A Kenya Power outage doesn't just switch off your lights, it also switches off your router and fibre box. If the power has come back but your internet hasn't, give the equipment a few minutes to fully restart, since the fibre box can take longer to come back online than your lights do.
...
Confirm it isn't a wider outage

Sometimes the problem isn't just in your house. Fibre cables can be affected by roadworks, construction, or heavy weather nearby. Check your provider's social media pages or support line for any announcements about outages in your area before assuming the fault is with your own equipment.

Check your account status

If you're on a prepaid plan, confirm that your subscription hasn't run out or that a payment didn't fail to go through. This is an easy thing to overlook when the internet stops working right in the middle of the month.
...
If you've worked through all of the above and you're still offline, it's time to contact your provider. Have your account details and a description of the router lights ready; it will make the call much faster.

A sudden outage is stressful, especially when you're relying on your connection for work or school. Netwell Fiber's support team is on hand to help you troubleshoot quickly and get a technician out when needed, so you're never left guessing what went wrong. Save our support line so it's ready whenever you need it.""",
...
Microwaves, baby monitors, cordless phones, and even some Bluetooth devices can interfere with Wi-Fi signals, particularly on the 2.4GHz band. If your router keeps dropping around the same time you use certain appliances, that's a strong clue.
...
Routers don't last forever. If yours is several years old and has been repeatedly restarted, updated, and repositioned with no improvement, it may simply be reaching the end of its usable life.
...
Start with the basics: reposition your router in an open, central spot, restart it regularly, and disconnect devices you're not using. If the problem continues after trying these steps, it's worth having your line and equipment checked by a technician, since the cause may be outside your home.

Constant disconnections shouldn't be something you just live with. Netwell Fiber provides stable, high-capacity connections built for busy Kenyan households, along with routers that are set up correctly from day one. If your connection keeps dropping, get in touch and we'll send a technician to sort it out properly.""",
            ...
            },
            {
                ...
                'body': """It's a strange but common complaint: your phone loads pages instantly, yet your smart TV buffers even with the exact same Wi-Fi network. The truth is, not every device experiences your internet the same way, even when they're connected to the same router. Here's what's really going on.
...
Phones move around with you, but TVs stay fixed in one spot, often against a wall and further from the router than you'd expect. Walls, furniture, and even the TV's own casing can weaken the signal reaching it, resulting in a noticeably slower connection than your phone experiences in another room.
...
Smart TVs often run background processes, app updates, and syncing that you don't see happening. These quietly use up bandwidth and can slow down your streaming without any obvious warning on screen.

An Ethernet cable can solve it instantly
...
Router placement affects every device differently

A router placed in a bedroom corner might give your phone (which you carry close to it) a strong signal, while your TV in the living room struggles with a weaker one. Central placement, away from walls and large furniture, improves the experience for every device in the house, not just one.

How to actually fix it

Try moving your TV closer to the router, switching it to the 5GHz band if available, or using a wired connection if that's not possible. Restarting the TV and router together can also help clear up temporary slowdowns.

If the issue persists even after trying these steps, your home may benefit from better Wi-Fi coverage. Netwell Fiber can assess your home setup and recommend the right router placement or additional access points, so every device, not just your phone, gets the speed you're paying for. Talk to our team about a free home coverage check.""",
            ...
            },
            {
                ...
                'body': """A smart TV that won't connect to Wi-Fi can turn a relaxing evening into a frustrating one, especially when your phone connects to the same network without any issue. Before you assume the TV is broken, work through these common causes; most smart TV connection problems have simple explanations.

Double-check the Wi-Fi password

It sounds obvious, but typing the Wi-Fi password on a TV remote is fiddly, and it's easy to mistype a character, especially with passwords that mix capital letters and numbers. Re-enter it carefully, or check your router for the correct password printed on the label.

Your TV may be trying to connect to the wrong band

If your router broadcasts separate 2.4GHz and 5GHz networks, make sure you're selecting the right one. Some older smart TVs can only connect to 2.4GHz, so if you only see the 5GHz network in the list, or the TV won't connect to it, try the 2.4GHz option instead.

Router settings may be blocking new devices

Some routers have device limits or filtering settings that prevent new devices from joining the network. If you've recently reset your router or changed settings, check whether device filtering is switched on and add your TV manually if needed.

The TV's software needs an update
...
The signal is too weak where the TV is placed
...
Streaming should be simple, not a fight with your TV settings. Netwell Fiber's support team can help you troubleshoot connection issues on any device, and our technicians can advise on the best router setup for a home full of smart TVs, consoles, and streaming boxes. Reach out and let's get your TV back online.""",
            ...
            },
            {
                ...
                'body': """Few things are more annoying than your show pausing to buffer right at the best part. Buffering happens when your device can't pull data fast enough to keep up with playback, and while it's easy to blame Netflix, the real cause is usually much closer to home.

Your internet speed may not match what you're streaming
...
It's easy to forget how many things are quietly using your internet in the background: a phone syncing photos, a laptop downloading an update, a smart TV in another room left on standby. All of this competes with your stream for bandwidth.
...
Outdated apps and outdated TV or streaming box software can cause playback issues that look like a slow connection but aren't. Check for pending updates on both the Netflix app and your device's system software.
...
Some internet plans slow down speeds after a certain amount of data has been used in a month, even if the plan is labelled unlimited. If your buffering seems to get worse as the month goes on, it's worth checking whether your plan has this kind of usage cap.

Simple fixes that actually work

Restart your router and streaming device, move closer to the router or switch to a wired connection, lower your streaming quality slightly if needed, and disconnect devices you're not actively using. Testing your internet speed at different times of day can also help you figure out whether the issue is constant or tied to peak hours.
...
Smooth streaming comes down to having enough speed for how your household actually uses the internet, not just a number on a plan. Netwell Fiber offers packages built for multi-device, multi-person homes, so everyone can stream in HD at the same time without the buffering wheel showing up. Check out our packages to find the right fit for your household.""",
            ...
            },
            {
                ...
                'body': """You've got full signal in the living room, but the moment you walk into the bedroom or kitchen, your Wi-Fi disappears. This is one of the most common complaints in homes with more than one room between them and the router, and it has a straightforward explanation: Wi-Fi signal weakens the further it has to travel, and certain things block it more than others.
...
Signal strength drops the further you get from the router, and it doesn't take a huge distance for it to become noticeable, especially in larger homes or those with multiple floors. A bedroom at the far end of the house is often simply too far from a router placed near the entrance.
...
If you've tried repositioning your router and dead zones persist, the fix usually isn't your internet plan, it's your home's coverage setup. Netwell Fiber technicians can assess your home layout and recommend the right combination of router placement, access points, or mesh coverage so every room gets a reliable connection, not just the one closest to the router. Ask us about a home Wi-Fi assessment when you sign up or if you're experiencing patchy coverage.""",
            ...
            },
            {
                ...
                'body': """\"Have you tried restarting your router?\" isn't just something support agents say to get you off the phone, it genuinely fixes a huge share of common internet problems. But there's a right way and a wrong way to do it, and doing it properly makes a real difference in how effective it actually is.

Why restarting fixes so many problems

Routers are small computers, and like any computer, they can build up minor glitches over time from constant use, temporary software errors, or too many connected devices. Restarting clears out this temporary buildup and forces the router to reconnect to the network fresh, which resolves a large number of everyday issues like slow speeds, dropped connections, and devices that won't connect.

Power cycling is different from just unplugging

Simply pulling the plug and immediately plugging it back in doesn't give the router enough time to fully power down. A proper restart, known as power cycling, means switching the device off completely, waiting a short period, and then switching it back on. This short pause is what allows the router's memory to clear properly before it starts back up.

The correct steps

Turn off your router and fibre box (ONT) if you have one separate from the router. Wait at least 30 seconds, a full minute is even safer. Turn the fibre box back on first and let it fully reconnect, usually indicated by steady lights. Then turn your router back on and give it another minute or two to fully boot up and reconnect to the network.
...
You don't need to restart your router daily, but doing it once every week or two, especially if your household has many connected devices, helps prevent slowdowns and glitches from building up. If you notice your internet consistently getting slower a few days before you'd normally restart it, that's a sign it's due for one.

When restarting doesn't help

If a proper restart doesn't fix the issue, the problem likely isn't with your router at all; it's more likely to be an issue with the incoming line, your account, or an outage in your area. At that point, it's time to check for known outages or contact your provider rather than continuing to restart the same equipment.

A simple restart, done properly, solves more problems than most people expect. But if you've followed these steps and you're still without a reliable connection, Netwell Fiber's support team is ready to help, whether that means remote troubleshooting or sending a technician to your home. Get in touch and we'll have you back online quickly.""",
